    ...
    <div class="page-content">
        ...
        @if ($buildings->count() < 1)
            <div class="col-span-12 text-center">
                <p>No buildings found for this complex. Create one using the <strong>'New Building'</strong> button.</p>
            </div>
        @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="join">
                                            ...
                                            <form action="{{ route('admin.buildings.delete-building', $building->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
